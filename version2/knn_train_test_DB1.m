...
fullMatFileName = fullfile(destdirectory,  'nina_pro_naveen_DB1_Train.mat')
...
fullMatFileName1 = fullfile(destdirectory,  'nina_pro_naveen_DB1_Test.mat')
if ~exist(fullMatFileName, 'file')
  message = sprintf('%s does not exist', fullMatFileName1);
  uiwait(warndlg(message));
else
 tempdata = load(fullMatFileName1);
...
% Auto-generated by MATLAB on 29-Oct-2021 11:43:55
...
predictors = Training_data_E123(:, 1:end-1);;
response = Training_data_E123(:, end);
...
trainedClassifier.HowToPredict = sprintf('To make predictions on a new predictor column matrix, X, use: \n  yfit = c.predictFcn(X) \nreplacing ''c'' with the name of the variable that is this struct, e.g. ''trainedModel''. \n \nX must contain exactly 100 columns because this model was trained using 100 predictors. \nX must contain only predictor columns in exactly the same order and format as your training \ndata. Do not include the response column or any columns you did not import into the app. \n \nFor more information, see <a href="matlab:helpview(fullfile(docroot, ''stats'', ''stats.map''), ''appclassification_exportmodeltoworkspace'')">How to predict using an exported model</a>.');% Extract predictors and response
% This code processes the data into the right shape for training the
% model.
% Convert input to table
% inputTable = array2table(trainingData, 'VariableNames', {'column_1', 'column_2', 'column_3', 'column_4', 'column_5', 'column_6', 'column_7', 'column_8', 'column_9', 'column_10', 'column_11', 'column_12', 'column_13', 'column_14', 'column_15', 'column_16', 'column_17', 'column_18', 'column_19', 'column_20', 'column_21', 'column_22', 'column_23', 'column_24', 'column_25', 'column_26', 'column_27', 'column_28', 'column_29', 'column_30', 'column_31', 'column_32', 'column_33', 'column_34', 'column_35', 'column_36', 'column_37', 'column_38', 'column_39', 'column_40', 'column_41', 'column_42', 'column_43', 'column_44', 'column_45', 'column_46', 'column_47', 'column_48', 'column_49', 'column_50', 'column_51', 'column_52', 'column_53', 'column_54', 'column_55', 'column_56', 'column_57', 'column_58', 'column_59', 'column_60', 'column_61', 'column_62', 'column_63', 'column_64', 'column_65', 'column_66', 'column_67', 'column_68', 'column_69', 'column_70', 'column_71', 'column_72', 'column_73', 'column_74', 'column_75', 'column_76', 'column_77', 'column_78', 'column_79', 'column_80', 'column_81'});
...
pred2 = predict(trainedClassifier.ClassificationKNN,Test_feat_E123(:,1:end-1));
conf2 = confusionmat(pred2,Test_feat_E123(:,end));
figure();
conf_chart = confusionchart(pred2,Test_feat_E123(:,end));
acc2 = (sum(diag(conf2)))/(sum(sum(conf2)))*100;
disp('Testing Accuracy of KNN');
disp(acc2);
Test_save = [Test_feat_E123(:,end) pred2];
n_class = 52;
...
Energy_DB1_test_data = Test_save_categorical(1:m3-1,:);
destdirectory = '/media/naveen/nav/mat_codes/nina_DB1_codes/nina_prep_naveen/energy/';
mkdir(destdirectory);   %create the director
file1 = sprintf('energy_DB1_test.csv');
...
csvwrite(fulldestination,Energy_DB1_test_data);
