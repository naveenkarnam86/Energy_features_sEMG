...
% [Finalconfmat,finkappa,TrainConfMat,TrainKappa,net1,net2,validationPredictions,targets_labels] = PNNClassifier4(predictors,response(:)',Nfold,spread,fldaflag);
% [Finalconfmat,finkappa,TrainConfMat,TrainKappa,net2] = ANNClassifier2(predictors,response(:)',Nfold,Nc,0,Nepoch,NHidden1,MinEr);
[Finalconfmat,finkappa,target_labels,validationPredictions,net2] = ANNClassifier_CV(predictors,response(:)',Nfold,Nc,fldaflag,NrNeuronLayer,Nepoch,NHidden1,MinEr);
...
metrics = MyClassifyPerf(target_labels, validationPredictions);
...
save results_FS01_ANN_0912020.mat res;
