...
%%
%--------------------------------------------------------------------------
% Energy features in 4 windows
% MAV features in 4 windows
% Spectral band powers in 4 windows 
% Give a performance:  87% CV accuracy
%--------------------------------------------------------------------------
...
% 
% [confmat1,test_kappa,pra,pre,test_acc] = ConfusionMatrix2(label,test_cl_vec,Nc);
% 
