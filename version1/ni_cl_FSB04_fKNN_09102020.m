...
% LMF features from ACT & BG 2019  
 ...
 feat_comb_data = [feat_comb_data feats_data];
 load feat_aryule_09162020.mat
 feat_comb_data = [feat_comb_data feats_data];
% Spectral band powers from ACT & BG
% load feat_SBP_pdg_06_dat.mat
%  feat_comb_data = [feat_comb_data feats_data];
%----------------------------------------------------------------------
...
load test_feat_td_CountzCross_NP52.mat
 ...
 test_feats = [test_feats feats_data];
 load test_feat_aryule_09162020.mat
 test_feats = [test_feats feats_data];
%  load test_feat_SBP_pdg6_NP52.mat
%  test_feats = [test_feats feats_data];
%  load test_feat_LBP_Rat_NP52.mat
%  test_feats = [test_feats feats_data];
%  
...
save results_FSB04_fKNN_09102020.mat res;
